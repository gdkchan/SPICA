    ...
    public class CMDL
    {
        ...
        public static void export(object model, string fileName, int index, int skeletalAnimationIndex = -1) {
            ...
            foreach (var mt in mdl.Materials.Contents) {
                ...
                matCol.Specular0.R = mt.MaterialParams.Specular0Color.R / 255;
                matCol.Specular0.G = mt.MaterialParams.Specular0Color.G / 255;
                matCol.Specular0.B = mt.MaterialParams.Specular0Color.B / 255;
                matCol.Specular0.A = mt.MaterialParams.Specular0Color.A / 255;
                matCol.Specular1.R = mt.MaterialParams.Specular1Color.R / 255;
                matCol.Specular1.G = mt.MaterialParams.Specular1Color.G / 255;
                matCol.Specular1.B = mt.MaterialParams.Specular1Color.B / 255;
                matCol.Specular1.A = mt.MaterialParams.Specular1Color.A / 255;
                matCol.Constant0.R = mt.MaterialParams.Constant0Color.R / 255;
                matCol.Constant0.G = mt.MaterialParams.Constant0Color.G / 255;
                matCol.Constant0.B = mt.MaterialParams.Constant0Color.B / 255;
                matCol.Constant0.A = mt.MaterialParams.Constant0Color.A / 255;
                matCol.Constant1.R = mt.MaterialParams.Constant1Color.R / 255;
                matCol.Constant1.G = mt.MaterialParams.Constant1Color.G / 255;
                matCol.Constant1.B = mt.MaterialParams.Constant1Color.B / 255;
                matCol.Constant1.A = mt.MaterialParams.Constant1Color.A / 255;
                matCol.Constant2.R = mt.MaterialParams.Constant2Color.R / 255;
                matCol.Constant2.G = mt.MaterialParams.Constant2Color.G / 255;
                matCol.Constant2.B = mt.MaterialParams.Constant2Color.B / 255;
                matCol.Constant2.A = mt.MaterialParams.Constant2Color.A / 255;
                matCol.Constant3.R = mt.MaterialParams.Constant3Color.R / 255;
                matCol.Constant3.G = mt.MaterialParams.Constant3Color.G / 255;
                matCol.Constant3.B = mt.MaterialParams.Constant3Color.B / 255;
                matCol.Constant3.A = mt.MaterialParams.Constant3Color.A / 255;
                matCol.Constant4.R = mt.MaterialParams.Constant4Color.R / 255;
                matCol.Constant4.G = mt.MaterialParams.Constant4Color.G / 255;
                matCol.Constant4.B = mt.MaterialParams.Constant4Color.B / 255;
                matCol.Constant4.A = mt.MaterialParams.Constant4Color.A / 255;
                matCol.Constant5.R = mt.MaterialParams.Constant5Color.R / 255;
                matCol.Constant5.G = mt.MaterialParams.Constant5Color.G / 255;
                matCol.Constant5.B = mt.MaterialParams.Constant5Color.B / 255;
                matCol.Constant5.A = mt.MaterialParams.Constant5Color.A / 255;
                ...
                fragShade.FragmentLighting.IsGeometricFactor0Enabled = (lightFlags & H3DFragmentFlags.IsLUTGeoFactor0Enabled) > 0;
