...
namespace SPICA.Formats.Common
{
    ...
    {
        public static List<PICAVertex> GetVerticesList(PatriciaList<H3DBone> Skeleton, H3DMesh Mesh)
        {
        ...
        public static PICAVertex[] GetWorldSpaceVertices(PatriciaList<H3DBone> Skeleton, H3DMesh Mesh)
        {
            PICAVertex[] Vertices = Mesh.ToVertices();
